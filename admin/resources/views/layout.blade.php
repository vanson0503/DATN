...
<script>
  ...
  function fetchAdminData() {
    ...
    fetch('http://localhost/food-api/public/api/admin/' + id)
      .then(response => response.json())
      .then(data => {
        // Update profile information in dropdown
        document.getElementById('userAvatar').src = data.image_url;
        document.getElementById('dropdownAvatar').src = data.image_url;
    ...
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <!-- Layouts -->
          <li class="menu-item {{ request()->routeIs('product.index')||request()->routeIs('category.index') ? 'active' : '' }}">
            <a href="#" class="menu-link menu-toggle">
              <i class="menu-icon tf-icons bx bx-layout"></i>
              <div data-i18n="Layouts">Catalog</div>
            </a>
          ...
          <li class="menu-item menu-item {{ request()->routeIs('admin')||request()->routeIs('customer') ? 'active' : '' }}">
